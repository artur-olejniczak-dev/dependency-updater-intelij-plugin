...
class PomParserMockitoTest {
    ...
    void testExtractDependenciesWithMocks() {
        // Konfigurujemy zachowanie atrap
        ...
        // Symulacja statycznej metody FilenameIndex z IntelliJ PSI
        try (MockedStatic<FilenameIndex> filenameIndexMock = Mockito.mockStatic(FilenameIndex.class);
            ...
            filenameIndexMock.when(() -> FilenameIndex.getFilesByName(mockProject, "pom.xml", mockScope))
                             .thenReturn(new PsiFile[]{mockXmlFile});
