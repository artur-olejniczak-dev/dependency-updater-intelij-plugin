...
class GradleParserRegexTest {
    ...
    void testTomlPatterns() {
        ...
        assertEquals("retrofit", mLib.group(1)); 
        assertEquals("com.squareup.retrofit2", mLib.group(2)); 
        assertEquals("retrofit", mLib.group(3)); 
        assertEquals("retrofit", mLib.group(4)); 
    }
}
