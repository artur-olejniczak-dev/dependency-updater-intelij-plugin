...
class TransitiveDependencyResolverTest {
    ...
    void testParsePaths() {
        ...
        // Oczekujemy tylko 2 wyników, ponieważ 3. to duplikat (sources) z tym samym groupId i artifactId
    ...
    void testFilterTransitive() {
        ...
        List<Dependency> directDependencies = List.of(
            new Dependency("org.springframework", "spring-core", "5.3.9") // Bezpośrednia
        );

        List<Dependency> transitiveOnly = resolver.filterTransitive(allDependencies, directDependencies);

        // spring-core zostaje odrzucone
